...
const statuses: Record<DisplayStatusKey, OrderDisplayStatus> = {
  ...
  pending_awb: { key: "pending_awb", label: "Menyiapkan pengiriman", detail: "Resi sedang dibuat otomatis" },
  awb_created: { key: "awb_created", label: "Resi dibuat", detail: "Paket menunggu proses BCE Express" },
  picked_up: { key: "picked_up", label: "Paket dijemput", detail: "Paket telah diterima BCE Express" },
