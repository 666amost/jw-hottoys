...
export default async function SearchPage({ searchParams }: SearchPageProps) {
  ...
  return (
    <div className="container-shell py-8 sm:py-12">
      ...
      <form className="-mt-4 mx-3 relative z-10 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_15px_50px_rgba(8,47,61,.12)] sm:mx-8 sm:flex-row" action="/search">
        ...
        <button className="h-11 rounded-xl bg-[#f7b718] px-6 text-sm font-extrabold text-[#082f3d] hover:bg-[#ffc83d]">
          Cari
        </button>
      </form>
